...
Descripción: Crea el usuario, las tablas e indices.
...
Fecha de creación: 27 Diciembre 2017
*************************************************************/
...
CREATE TABLE UNIFORMES.TADESCUENTOSSAPXPEDIDO(
    ...
    FISUCURSAL          NUMBER(8) NOT NULL,  --PK
    FISKU               NUMBER(15) NOT NULL, --PK
    FISEMANADESCUENTO   NUMBER(2) NOT NULL,  --PK
...
CREATE TABLE UNIFORMES.TAESTATUSABASTO(
    FIESTATUS       NUMBER (20) NOT NULL, --PK
    FCMENSAJE       VARCHAR2 (100) NULL
)
    TABLESPACE TBS_UNIFORMES_CAT_DAT
    LOGGING;
...
CREATE OR REPLACE TYPE TYPENOTACARGOENTRADA AS OBJECT 
( 
    FIFOLIOSOLICITUD            NUMBER(20),
...
/
CREATE OR REPLACE TYPE TYPEARRNOTACARGOENTRADA AS TABLE OF UNIFORMES.TYPENOTACARGOENTRADA;
/
...
CREATE OR REPLACE TYPE TYPESOLICITUDDETALLE AS OBJECT(
...
/
CREATE OR REPLACE TYPE TYPEARRSOLICITUDDETALLE AS TABLE OF UNIFORMES.TYPESOLICITUDDETALLE;
/
...
CREATE OR REPLACE TYPE TYPEDISTRIBUCIONSAP AS OBJECT ( 
    FIFOLIOSOLICITUD    NUMBER(20),    
    FIIDDETALLE         NUMBER (10),
    FIPAIS              NUMBER(3),
    FICANAL             NUMBER(10),
...
/
CREATE OR REPLACE TYPE TYPEARRDISTRIBUCIONSAP AS TABLE OF UNIFORMES.TYPEDISTRIBUCIONSAP;
/

CREATE OR REPLACE TYPE TYPECARGASPPI AS OBJECT(
    FIFOLIOSOLICITUD    NUMBER(20),
    FIIDDETALLE         NUMBER(20),
    FIPEDIDO            NUMBER(10),
...
/
CREATE OR REPLACE TYPE TYPEARRCARGASPPI AS TABLE OF UNIFORMES.TYPECARGASPPI;
/
