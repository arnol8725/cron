 ...
 *         &lt;element name="AvanceCarga" type="{http://conectorunico/schemas}avanceCargaVirtual" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "avanceCargaVirtualResponse")
public class AvanceCargaVirtualResponse {
    ...
    protected List<AvanceCargaVirtual> avanceCarga;
     ...
     * 
     */
    public List<AvanceCargaVirtual> getAvanceCarga() {
        if (avanceCarga == null) {
            avanceCarga = new ArrayList<AvanceCargaVirtual>();
        }
