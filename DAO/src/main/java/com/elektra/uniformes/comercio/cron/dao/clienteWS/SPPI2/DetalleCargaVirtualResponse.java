 ...
 *         &lt;element name="DetalleCarga" type="{http://conectorunico/schemas}detalleCargaVirtual" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "detalleCargaVirtualResponse")
public class DetalleCargaVirtualResponse {
    ...
    protected List<DetalleCargaVirtual> detalleCarga;
     ...
     * 
     */
    public List<DetalleCargaVirtual> getDetalleCarga() {
        if (detalleCarga == null) {
            detalleCarga = new ArrayList<DetalleCargaVirtual>();
        }
