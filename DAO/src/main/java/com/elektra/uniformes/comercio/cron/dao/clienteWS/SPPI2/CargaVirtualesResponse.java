 ...
 *         &lt;element name="ErroresCarga" type="{http://conectorunico/schemas}errorCargaVirtual" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "cargaVirtualesResponse")
public class CargaVirtualesResponse {
    ...
    protected List<ErrorCargaVirtual> erroresCarga;
     ...
     * {@link ErrorCargaVirtual }
     * 
     * 
     */
    public List<ErrorCargaVirtual> getErroresCarga() {
        if (erroresCarga == null) {
            erroresCarga = new ArrayList<ErrorCargaVirtual>();
        }
